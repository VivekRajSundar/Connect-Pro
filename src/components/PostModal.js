...
const PostModal = (props) => {
  ...
  const handleChange = (e) => {
    ...
    if (image === "" || image === undefined) {
      alert(`not an image, the file type is ${typeof image}`);
      return;
    }
  ...
  const postArticle = (e) => {
    ...
    console.log(getFirestore(firebaseApp).Timestamp.now());
    const payload = {
      image: shareImage,
      video: videoLink,
      //  user: props.user,
      description: editorText,
      //timestamp: getFirestore(firebaseApp).Timestamp.now(),
    };
    console.log(payload);
              ...
              <Editor>
                ...
                {assetArea === "image" ? (
                  <UploadImage>
                    <input
                      type="file"
                      accept="image/gifs, image/png, image/jpeg"
                      name="image"
                      id="file"
                      style={{ display: "none" }}
